...
const Charity = () => {
  return (
    <div id="Charity" style={{padding: '100px 50px 75px 50px'}}>
      <h3>Charity Work</h3>
      <Carousel responsive={CAROUSEL_RESPONSIVE_SIZES_CHARITY} draggable swipeable infinite /*autoPlay*/ autoPlaySpeed={4000} transitionDuration={500} removeArrowOnDeviceType={["tablet", "mobile"]}>
        <div style={{height: 'inherit', padding: '20px 0px 20px 20px', display: 'flex', flexDirection: 'column'}}>
          ...
          <caption>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut</caption>
        </div>
        <div style={{height: 'inherit', padding: '20px 0px 20px 20px', display: 'flex', flexDirection: 'column'}}>
          <img src={SecondImage} alt="Carousel Image" style={{height: 300, width: '100%', objectFit: 'cover'}} />
          <caption>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</caption>
        </div>
        <div style={{height: 'inherit', padding: '20px 0px 20px 20px', display: 'flex', flexDirection: 'column'}}>
