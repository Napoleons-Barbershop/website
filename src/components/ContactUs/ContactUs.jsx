        ...
        <Col>
          <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <div style={{display: 'flex', alignItems: 'center'}}>
              ...
              <address style={{fontSize: '0.75rem', fontStyle: 'normal', width: 285, color: LIGHT_BROWN}}>
            ...
            <div style={{display: 'flex', alignItems: 'center'}}>
              ...
              <a href={`tel:${BARBERSHOP_MOBILE_NO}`} style={{fontSize: '0.75rem', fontStyle: 'normal', textDecoration: 'none', width: 285, color: LIGHT_BROWN}}>
            ...
            <div style={{display: 'flex', alignItems: 'center'}}>
              ...
              <a href={`mailto:${BARBERSHOP_EMAIL}`} style={{fontSize: '0.75rem', fontStyle: 'normal', textDecoration: 'none', width: 285, color: LIGHT_BROWN}}>
                {BARBERSHOP_EMAIL}
              </a>
            </div>
          </div>
